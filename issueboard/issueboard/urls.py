...
from issue.views import initial, home, home_issuepost, add_issue, issue_submit, issue_detail, issue_chat_submit, \
    user_login, user_logout, user_register, about, contact, export
...
urlpatterns = [
    ...
    url(r'^issuepost$', home_issuepost, name='home_issuepost'),
